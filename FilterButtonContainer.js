...
const FilterButtonContainer = ({ clearTodos, changeFilter }) => {
  ...
  return (
    <div className="o-app__filterBtnContainer" ref={filterButtonContainer}>
      <FilterButton className="filter" filter="ALL" filterClickHandler={setActiveFilter}>All</FilterButton>
      <FilterButton className="filter" filter="ACTIVE" filterClickHandler={setActiveFilter}>Active</FilterButton>
      <FilterButton className="filter" filter="COMPLETED" filterClickHandler={setActiveFilter}>Completed</FilterButton>
      <FilterButton className="filter" ariaLabel="Clear Completed Todos" filter="ALL" filterClickHandler={setSelectedDataAfterClear}>Clear Completed</FilterButton>
    </div>
  );
}
